    ...
    <section id="contact" className="px-6 py-20 md:px-10">
      <div className="mx-auto max-w-5xl rounded-4xl bg-slate-950 px-8 py-16 text-center text-white shadow-[0_28px_70px_rgba(15,23,42,0.18)] md:px-12">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-lg text-slate-300">
          We’ll review your website, Google visibility and WhatsApp readiness to uncover clear opportunities for growth.
        </p>

        <a
          href="#home"
          className="mt-8 inline-flex items-center justify-center rounded-full bg-white px-7 py-3.5 text-base font-semibold text-slate-950 transition hover:-translate-y-0.5 hover:bg-slate-100"
        >
